...
@WebServlet("/closeTenders")
public class OwnerCloseTenders extends HttpServlet{
	...
	public void doGet(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException {
		try {
			...
			request.getRequestDispatcher("owner/ownercloseTender.jsp").forward(request, response);
		}catch(Exception e) {
			e.printStackTrace();
		}
